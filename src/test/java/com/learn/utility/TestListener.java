...
public class TestListener implements ITestListener {
	...
	public void onTestSuccess(ITestResult result) {
		...
		test.log(Status.PASS,
				MarkupHelper.createLabel("Name of the skip test case is: " + result.getName(), ExtentColor.GREEN));
	}
	...
	public void onFinish(ITestContext context) {
		...
		reports.flush();// it is mandatory to call flush method to ensure information is written ti the
						// started reporter.
	}
